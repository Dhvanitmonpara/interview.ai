...
import { Moon, Sun, Play, ArrowRight, Pencil, Share2 } from "lucide-react"
          ...
          <div className="container">
            ...
            >
              <div className="inline-flex items-center rounded-full border px-4 py-1.5 text-sm mb-4">
                <span className="bg-primary/20 text-primary rounded-full px-2 py-0.5 text-xs mr-2">New</span>
                <span>AI-Powered Video Interviews</span>
              </div>
              <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">Buil your Future With AI</h1>
              <p className="text-xl text-muted-foreground">
                Target all your clients during key moments throughout their product journey
              </p>
        ...
        <section className="py-16 bg-muted/50">
          <div className="container">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground">Give mock interview in just 3 simple easy steps</p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: "Create custom interview questions tailored to your needs",
                },
                {
                  icon: <ArrowRight className="h-8 w-8" />,
                  title: "Edit Your form",
                  description: "Customize and refine your interview structure",
                },
                {
                  icon: <Share2 className="h-8 w-8" />,
                  title: "Share & Start Accepting Responses",
                  description: "Distribute your interview and collect insights",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <Card className="text-center">
                    <CardContent className="pt-6">
                      <div className="rounded-full bg-primary/10 p-4 inline-block mb-4">{item.icon}</div>
        ...
        <section className="py-16">
          <div className="container">
            <motion.div
              ...
              variants={fadeIn}
            >
              <p className="text-primary font-medium">BUILT WITH MODERN TECH STACK</p>
                ...
                {[
                  {
                    ...
                    icon: (
                      <svg viewBox="0 0 24 24" className="w-12 h-12 mx-auto mb-4 text-[#61DAFB]" fill="currentColor">
                  ...
                  },
                  {
                    ...
                    icon: (
                      <svg viewBox="0 0 24 24" className="w-12 h-12 mx-auto mb-4 text-[#38BDF8]" fill="currentColor">
                  ...
                  {
                    title: "TypeScript",
                    description: "JavaScript with syntax for types, enhancing code quality",
                    icon: (
                      <svg viewBox="0 0 24 24" className="w-12 h-12 mx-auto mb-4 text-[#3178C6]" fill="currentColor">
