...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-all duration-500 w-screen overflow-x-hidden">
      ...
      <section className="grid md:grid-cols-3 gap-6 mt-8 container mx-auto px-4">
        <Card className="p-6 text-center shadow-lg transform hover:scale-105 transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          ...
          <CardContent className="text-gray-600 dark:text-gray-300">
            Practice with real-time video and AI-based facial expression analysis.
          </CardContent>
        </Card>
        ...
        <Card className="p-6 text-center shadow-lg transform hover:scale-105 transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          ...
          <CardContent className="text-gray-600 dark:text-gray-300">
            Solve coding problems with an interactive code editor.
          </CardContent>
        </Card>
        ...
        <Card className="p-6 text-center shadow-lg transform hover:scale-105 transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          ...
          <CardContent className="text-gray-600 dark:text-gray-300">
            Get insights into your performance with AI-powered analysis.
          </CardContent>
        </Card>
      </section>

      <section className="grid md:grid-cols-2 gap-6 mt-12 container mx-auto px-4">
        <Card className="p-6 text-center shadow-lg transform hover:scale-105 transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          ...
          <CardContent className="text-gray-600 dark:text-gray-300">
            Simulate real interview scenarios with AI-driven responses.
          </CardContent>
        </Card>
        ...
        <Card className="p-6 text-center shadow-lg transform hover:scale-105 transition-all duration-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          ...
          <CardContent className="text-gray-600 dark:text-gray-300">
            Receive instant AI-generated feedback on your answers.
          </CardContent>
        </Card>
      </section>
